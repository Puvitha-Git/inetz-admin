...
const AddStudentPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!specificDomain)
      newErrors.specificDomain = "Please select a specific domain";
      ...
      Email <span style={{ color: 'red' }}>*</span>
            ...
            {duration && (
              <FormControl fullWidth size="small" error={!!errors.domain}>
                <InputLabel>
                  Main Domain <span style={{ color: "red" }}>*</span>
                </InputLabel>
                <Select
                  value={domain}
                  label="Main Domain *"
            ...
            {domain && getSpecificDomains().length > 0 && (
              <FormControl
                fullWidth
                size="small"
                error={!!errors.specificDomain}
              >
                <InputLabel>
                  Specific Domain <span style={{ color: "red" }}>*</span>
                </InputLabel>
                <Select
